En este repositorio se almacena solo la interfaz sin funcionamiento de una aplicación para calcular la propina, tomando en cuenta el precio del servicio y el porcentaje que el usuario quiera dejar.
